# 객실 PIN Phase A/B 및 초기화 운영 인계

## 범위와 배포 상태

이 문서는 Issue #131 Phase A, Issue #136 Phase B와 Issue #140 초기화 계약을 설명한다. 통합 기준은 `dev@3e54e3ebfe09ea7ef206c4997cc0a907e010e431`, 50 migrations / 102 paths / 109 operations이고 #140 candidate는 51번째 append-only migration과 1개 공개 operation을 추가해 103 paths / 110 operations가 된다. feature → `dev` 검증만 수행하며 production/main/recovery migration, Edge, Cron, Vault, Google hosted 설정은 변경하지 않는다.
