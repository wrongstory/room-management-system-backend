...
where name = 'assignment_pin_entitlement';
...
select is(
  ...
  'photo_retention_v2',
  'database status exposes migration 63 when migration 64 is absent'
);
...
select is(
  ...
  'behind',
  'database status reports migration 63 behind source migration 64'
);
