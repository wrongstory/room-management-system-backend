...
def test_password_change_replay_errors_are_generated() -> None:
    ...
    assert {
        ...
        ErrorCode.PASSWORD_VERIFICATION_RATE_LIMITED.value,
        ErrorCode.PASSWORD_VERIFICATION_RATE_LIMIT_UNAVAILABLE.value,
        ErrorCode.PASSWORD_VERIFICATION_SESSION_REVOKE_FAILED.value,
        ErrorCode.PASSWORD_RESET_STATE_UPDATE_FAILED.value,
    } == {
